...
稳定版由 `v*` tag 发布。安装脚本默认下载 GitHub latest 指向的最新稳定版。如果需要固定可复现版本，可以设置 `CAUSHELL_VERSION`，例如 `CAUSHELL_VERSION=v0.0.5`。
...
caushell update --version v0.0.5     # 固定一个稳定 release tag
